...
% estimate the model parameters using KF method used by Feunou and Okou (2016)
...
% consider noisy parameters as an initial parameters for KF estimation 
...
for di = 1:50
  ...
  save(['results/estimation/Simulation/simulated_path_kf_',int2str(id)],'series','model','results')
end
